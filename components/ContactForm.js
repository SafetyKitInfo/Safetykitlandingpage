    ...
    <section id="contact" className="py-20 bg-slate-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sk-primary mb-3">Waitlist</p>
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3">Join the waitlist</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Sign up to be first in line for SafetyKit updates, pilots, and early access.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <div className="bg-sk-primary rounded-xl p-8 text-white">
            <h3 className="text-lg font-bold mb-6">What you get</h3>
            ...
            <div className="mt-8 pt-6 border-t border-teal-600">
              <p className="text-xs text-teal-200">No credit card required · Reply within 1 business day</p>
            </div>
          </div>

          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 flex flex-col justify-center">
